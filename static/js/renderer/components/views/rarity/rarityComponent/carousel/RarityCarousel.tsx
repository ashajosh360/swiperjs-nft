...
import { getName, getRarityName, getRarityPercent } from "./name";
import "./index.scss";
          ...
          >
            {activeIndex < imageArray?.length! ? (
              <span className="left-label">
                ...
                <p id="bottom-line">{getRarityPercent(imageArray![activeIndex], filter)} have this trait</p>
              </span>
            ) : (
              <span className="left-label">
                <p id="top-label" style={{ textAlign: "left" }}>
                ...
                <p id="bottom-line">{getRarityPercent(imageArray![0], filter)} have this trait</p>
              </span>
            )}
            <Divider
